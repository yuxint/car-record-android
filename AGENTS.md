...
- ios项目目录：`/Users/tx/develepment/workspace/car-record`，具体阅读`/Users/tx/develepment/workspace/car-record/AGENTS.md`，业务规则，交互逻辑和文案等需要强一致，视觉和组件风格都按Android的Material体系处理，需要用子线程来参考ios项目
